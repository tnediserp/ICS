...
long long gen_d_srcA()
{
    return (((if_id_curr->icode) == (I_RRMOVQ) || (if_id_curr->icode) == 
        ...
        (I_IADDQ)) ? (if_id_curr->rb) : ((if_id_curr->icode) == (I_POPQ)
...
{
    return ((((if_id_curr->icode) == (I_IADDQ)) & ((mem_wb_next->valm) > 0))
       ? 1 : (((if_id_curr->icode) == (I_IADDQ)) & ((mem_wb_next->valm) <= 0)
        ) ? 0 : ((if_id_curr->icode) == (I_CALL) || (if_id_curr->icode) == 
...
long long gen_aluA()
{
    return (((id_ex_curr->icode) == (I_RRMOVQ) || (id_ex_curr->icode) == 
        (I_ALU)) ? (id_ex_curr->vala) : (((id_ex_curr->icode) == (I_IADDQ))
         & ((id_ex_curr->valc) == 1)) ? (id_ex_curr->vala) : (
